...
graph1 <- ggplot(diamonds, aes(x=carat, y=price, color=color)) + geom_point() + ggtitle("Diamonds- Weight to Price by Color") + xlab("Weight") + ylab("Price") + labs(color="factor(color)")+theme(plot.title = element_text(size = rel(1.4),colour="blue"))
print(graph1)
...
graph2 <- ggplot(diamonds, aes(x=log(carat), y=log(price), color=color)) + geom_point() + ggtitle("Diamonds- Weight to Price(Linear)") + xlab("Weight") + ylab("Price") + labs(color="factor(color)") + theme(plot.title = element_text(size = rel(1.8),colour="blue"))
print(graph2)
...
graph3 <- ggplot(diamonds, aes(x=log(carat), y = (residual), color = color)) +geom_point() + ggtitle("Diamonds- Weight to Price by Color") + xlab("Weight") + ylab("Price") + labs(color="factor(color)")+theme(legend.position = "top") + theme(plot.title = element_text(size = rel(1.6),colour="blue"))
print(graph3)
...
mainplot <- ggplot(diamonds, aes(x=log(carat), y = (residual), color = color)) +geom_point() + ggtitle("Diamonds- Weight to Price by Color") + xlab("Weight") + ylab("Price Residuals") + labs(color="factor(color)") + theme(legend.position = "top") +theme(plot.title = element_text(size = rel(1.6),colour="blue"))
